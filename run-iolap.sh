...
NUM_PARTS="${NUM_PARTS:-8000}"
SLAQ_INTERVAL_MS="${SLAQ_INTERVAL_MS:-5000}"
NAGA_INTERVAL_MS="${NAGA_INTERVAL_MS:-30000}"
...
# Set output path
OUTPUT_DIR="data/$SCHEDULER_NAME"_"$NUM_POOLS"pools_"$BOOTSTRAP_TRIALS"bootstrap_"$NUM_PARTS"parts_"$INPUT_NAME"
