...
LOG_DIR="${LOG_DIR:-/home/stafman/iolap/logs/}"
EXPR_NAME="${EXPR_NAME:-tpchconvert}"
RUNTIME_MEMORY="${RUNTIME_MEMORY:-6g}"
...
bin/spark-submit\
  ...
  --class org.apache.spark.examples.sql.hive.DBgen2Parquet\
