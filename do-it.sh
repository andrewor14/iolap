...
INPUT_PATH="data/students.json" ./run-iolap.sh true 10 500
INPUT_PATH="data/students.json" ./run-iolap.sh false 10 500
INPUT_PATH="data/students10.json" ./run-iolap.sh true 10 500
INPUT_PATH="data/students10.json" ./run-iolap.sh false 10 500
INPUT_PATH="data/students1g.json" ./run-iolap.sh true 10 500
INPUT_PATH="data/students1g.json" ./run-iolap.sh false 10 500
INPUT_PATH="data/students10g.json" ./run-iolap.sh true 10 500
INPUT_PATH="data/students10g.json" ./run-iolap.sh false 10 500
